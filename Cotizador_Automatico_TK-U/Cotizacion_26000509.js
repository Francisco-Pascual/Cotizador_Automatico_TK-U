...
//convirtiendo la edad ingrasada a número
var edad_numero = parseInt(edad)
//verofocamos si es es manor 
if (edad_numero < 18){
  alert("Losentimos, el seguro no esta disponible para menores de edad.");
  throw new Error("Menor de edad"); //detiene el script
}
